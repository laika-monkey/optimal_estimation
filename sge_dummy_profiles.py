...
##		'surf_temp'	: linspace(-286.8, 296.8, 11),
	...
	#_explicit surface tempreature or default to -1
	'surf_temp' : 301.4,
	...
	'dir_lblrtm'	: '/data/wsessions/LBL-RTM_simulated/test_fov',

	#_used... for... HBB?
#	'real_shis'	: 'SHIS_rdr20130916T210344end20130917T020353' + 
#					'sdr20140110T030108_rad_pcfilt.nc',
    'real_shis' : 'SHIS_rdr20130825T065605end20130825T102611' + 
					'sdr20140109T072724_rad_pcfilt.nc',
    'idx'       : [381],
...
f = 'QUARTZ_SHIS.CPL.COLLOC.SIMULATED.{0}{1}.hdf'.format(*a)
...
##	real_shis = read_shis(ugh, idx=array([0])) 
	...
	srpt = os.path.expanduser('~/lib/sge_dummy_profiles.py')
